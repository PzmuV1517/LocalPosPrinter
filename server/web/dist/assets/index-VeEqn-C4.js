import{Filter as a,GpuProgram as f,GlProgram as c,BlurFilter as Xn,AlphaFilter as Kn,BlurFilterPass as ge,ImageSource as Yn,ViewSystem as Wn}from"./index-7oxBESFf.js";import{h as d,i as y,j as F,k as C,D as $,T as qn,O as jn,l as Zn}from"./ParticleBuffer-jALm7PRq.js";import"./index-5KSmS8Ef.js";var m=`in vec2 aPosition;
...
{
  return x - y * floor(x/y);
}`;class xi extends a{constructor(){const e=f.from({vertex:{source:p,entryPoint:"mainVertex"},fragment:{source:pt,entryPoint:"mainFragment"}}),n=c.from({vertex:m,fragment:mt,name:"cross-hatch-filter"});super({gpuProgram:e,glProgram:n,resources:{}})}}var vt=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
}`,At=Object.defineProperty,wt=(r,e,n)=>e in r?At(r,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):r[e]=n,Ut=(r,e,n)=>(wt(r,e+"",n),n);class bi extends a{constructor(e=5){const n=f.from({vertex:{source:p,entryPoint:"mainVertex"},fragment:{source:Ot,entryPoint:"mainFragment"}}),t=c.from({vertex:m,fragment:Ft,name:"emboss-filter"});super({gpuProgram:n,glProgram:t,resources:{embossUniforms:{uStrength:{value:e,type:"f32"}}}}),Ut(this,"uniforms"),this.uniforms=this.resources.embossUniforms.uniforms}get strength(){return this.uniforms.uStrength}set strength(e){this.uniforms.uStrength=e}}var It=`precision highp float;
in vec2 vTextureCoord;
out vec4 finalColor;
...
}`;class Pi extends a{constructor(){const e=f.from({vertex:{source:p,entryPoint:"mainVertex"},fragment:{source:Wt,entryPoint:"mainFragment"}}),n=c.from({vertex:m,fragment:Yt,name:"grayscale-filter"});super({gpuProgram:e,glProgram:n,resources:{}})}}var qt=`in vec2 vTextureCoord;
out vec4 finalColor;
...
fn rand(co: vec2<f32>, seed: f32) -> f32
{
  ...
  return fract(sin(sn) * c + seed);
}`,ni=Object.defineProperty,ri=(r,e,n)=>e in r?ni(r,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):r[e]=n,In=(r,e,n)=>(ri(r,typeof e!="symbol"?e+"":e,n),n);const Rn=class Dn extends a{constructor(e){e={...Dn.DEFAULT_OPTIONS,...e};const n=e.maxKernelSize??32,t=f.from({vertex:{source:p,entryPoint:"mainVertex"},fragment:{source:ei.replace("${MAX_KERNEL_SIZE}",n.toFixed(1)),entryPoint:"mainFragment"}}),o=c.from({vertex:m,fragment:Jo.replace("${MAX_KERNEL_SIZE}",n.toFixed(1)),name:"zoom-blur-filter"});super({gpuProgram:t,glProgram:o,resources:{zoomBlurUniforms:{uStrength:{value:e.strength,type:"f32"},uCenter:{value:{x:0,y:0},type:"vec2<f32>"},uRadii:{value:new Float32Array(2),type:"vec2<f32>"}}}}),In(this,"uniforms"),this.uniforms=this.resources.zoomBlurUniforms.uniforms,Object.assign(this,e)}get strength(){return this.uniforms.uStrength}set strength(e){this.uniforms.uStrength=e}get center(){return this.uniforms.uCenter}set center(e){Array.isArray(e)&&(e={x:e[0],y:e[1]}),this.uniforms.uCenter=e}get centerX(){return this.uniforms.uCenter.x}set centerX(e){this.uniforms.uCenter.x=e}get centerY(){return this.uniforms.uCenter.y}set centerY(e){this.uniforms.uCenter.y=e}get innerRadius(){return this.uniforms.uRadii[0]}set innerRadius(e){this.uniforms.uRadii[0]=e}get radius(){return this.uniforms.uRadii[1]}set radius(e){this.uniforms.uRadii[1]=e<0||e===1/0?-1:e}};In(Rn,"DEFAULT_OPTIONS",{strength:.1,center:{x:0,y:0},innerRadius:0,radius:-1,maxKernelSize:32});let $i=Rn;export{ui as AdjustmentFilter,li as AdvancedBloomFilter,si as AsciiFilter,ai as BackdropBlurFilter,fi as BevelFilter,ci as BloomFilter,mi as BulgePinchFilter,yi as CRTFilter,pi as ColorGradientFilter,vi as ColorMapFilter,di as ColorOverlayFilter,gi as ColorReplaceFilter,hi as ConvolutionFilter,xi as CrossHatchFilter,Si as DotFilter,Ci as DropShadowFilter,bi as EmbossFilter,_i as GlitchFilter,Ti as GlowFilter,zi as GodrayFilter,Pi as GrayscaleFilter,Fi as HslAdjustmentFilter,_e as KawaseBlurFilter,Oi as MotionBlurFilter,Ai as MultiColorReplaceFilter,wi as OldFilmFilter,Ui as OutlineFilter,Ii as PixelateFilter,Mi as RGBSplitFilter,Ri as RadialBlurFilter,Di as ReflectionFilter,Li as ShockwaveFilter,Gi as SimpleLightmapFilter,Ei as SimplexNoiseFilter,ee as TiltShiftAxisFilter,Ni as TiltShiftFilter,Bi as TwistFilter,$i as ZoomBlurFilter,Xr as angleFromCssOrientation,Kr as angleFromDirectionalValue,$r as colorAsStringFromCssStop,Vr as offsetsFromCssColorStops,Er as parseCssGradient,Br as stopsFromCssStops,Yr as trimCssGradient,Nr as typeFromCssType,m as vertex,p as wgslVertex};
