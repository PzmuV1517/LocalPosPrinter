...
object ReceiptRenderer {
    ...
    private const val ALERT_SIZE = 62f         // the big "ALERT" header
    private const val ALERT_TYPE_SIZE = 34f    // the severity type line
    private const val ALERT_TEXT_SIZE = 44f    // size of the alert message body (most important for legibility)
    private const val ALERT_DASH_SIZE = 20f    // size of the "- - -" dash rule
    private const val ALERT_STAR_SIZE = 20f    // size of the "* * *" star rule
    private const val ALERT_FOOTER_SIZE = 30f
    private const val ALERT_THANKS_SIZE = 24f      // "Thank you for using M.U.I.E."
    private const val ALERT_EXPANSION_SIZE = 20f   // "(Minimal Unified Incident Envelope)"
    private const val ALERT_HEADER_SPACING = 6f    // vertical padding around header lines (ALERT / type)
    private const val ALERT_FOOTER_SPACING = 6f    // vertical padding around footer lines (service/time, thanks, expansion)
